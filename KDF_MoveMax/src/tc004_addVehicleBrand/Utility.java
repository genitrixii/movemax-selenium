...
public class Utility {
	...
	public void radio_select(String fText) {
...
//		}
		if (fText != "") {
			driver.findElement(By.xpath("(//mat-radio-button[contains(@class, 'mat-radio-button')])[" + fText + "]"))
					.click();
		} else {
	...
	public void saveScreen(int index) {
		...
		try {
			ImageIO.write(image, "png", new File(
					"D:/eclipse-workspace-tester/KDF_MoveMax/Excel/Screencaps/TC003" + "_" + (index + 1) + ".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
